<?php
  ...
  if (isset($_POST['send-invoice'])) {
    ...
    $sql1 = "SELECT * FROM pi_tbl_inv_detail WHERE invoice_no = ?";
    ...
    // TRANSACTION
    if (empty($trnError)) {
      $sql2 = "INSERT INTO pi_tbl_inv_detail(user_id,invoice_no,payment_mode,cname,cphone,caddress) VALUES(?,?,?,?,?,?)";
...
<head>
  <meta charset="utf-8">
  <title>AMU GRV</title>
  <?php include("../pi_includes/metadata.php");?>
  <script>
...
<body>
  <?php include('../pi_includes/header.php'); ?>
