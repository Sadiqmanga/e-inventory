...
if(isset($_POST['add-product'])){
    ...
    $sql = "SELECT * FROM tbl_products WHERE name = ?";
 ...
 if (isset($_GET['delete'])) {
    ...
    $mysqli->query("DELETE FROM tbl_carts WHERE invoice_no=$invoice_no");
    $mysqli->query("DELETE FROM tbl_inv_detail WHERE invoice_no=$invoice_no");
    $mysqli->query("DELETE FROM tbl_transactions WHERE invoice_no=$invoice_no");
    echo
        "<script>
            (function() {
                window.addEventListener('load', function() {
