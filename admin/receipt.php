                    ...
                    <div class="row justify-content-center">
						<div class="col-12 col-lg-10 col-xl-9">
							<div class="row align-items-center no-print">
								...
								<div class="col-auto">
									<a href="manage-invoices.php" class="btn btn-outline-secondary">
										Back
									</a>
									...
									<div class="card card-invoice">
										<div class="card-header">
											...
											<div class="invoice-desc">
												<strong class="font-custom1">AMU GLOBAL RESOURCE VENTURES</strong><br/>
												Dealer in all kinds of footwears such as SINO, SUPER, BALLY etc.<br>
                                               <strong>Tel: 09012497962 | 09160142644</strong> 
											</div>
										</div>
										<div class="card-body">
										...
										<div class="card-footer">
											...
											<p class="mb-0">
                                                ...
                                                | We really appreciate you doing business with us.<br>
