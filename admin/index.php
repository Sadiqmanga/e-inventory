			...
			<div class="bg-secondary pt-4 pb-5">
				<div class="container text-white py-2">
					<div class="d-flex align-items-center">
						<div class="mr-3">
							<h2 class="mb-3">AMU Global Resource Ventures <br>ADMIN DASHBOARD</h2>
						</div>
						...
						<div class="col-6 col-sm-4 col-lg-3">
							<div class="card">
								<div class="card-body text-secondary2 p-3 text-center">
									<div class="h1 m-0">
									<?php
										$result1 = mysqli_query($mysqli, "SELECT SUM(total_amount) AS grandTotal, date FROM tbl_transactions WHERE date=CURDATE()"); 
						...
						<div class="col-6 col-sm-4 col-lg-3">
							<div class="card">
								<div class="card-body text-secondary2 p-3 text-center">
									<div class="h1 m-0">
										<?php
											$result2 = mysqli_query($mysqli, "SELECT SUM(discount) AS totalDiscount, date FROM tbl_transactions WHERE date=CURDATE()"); 
						...
						<div class="col-6 col-sm-4 col-lg-3">
							<div class="card">
								<div class="card-body text-secondary2 p-3 text-center">
									<div class="h1 m-0">
										<?php
											$sql3="SELECT count('1') FROM tbl_transactions WHERE DATE(date_created)=CURDATE()";
