...
if(isset($_POST['add-product'])){
    ...
    $sql = "SELECT * FROM tbl_products WHERE category = ? AND name = ?";
    ...
    if (empty($product_err)) {
        $sql2 = "INSERT INTO tbl_products(category,name,unit_price,status) VALUES(?, ?, ?, ?)";
...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $mysqli->query("DELETE FROM tbl_products WHERE id=$id") or die($mysqli->connect_error);
    echo
        "<script>
            (function() {
                window.addEventListener('load', function() {
...
if (isset($_POST['update-product'])) {
	...
	if($mysqli->query("UPDATE tbl_products SET unit_price='$unit_price', status='$status' WHERE id=$id")){
		echo
        "<script>
            (function() {
                window.addEventListener('load', function() {
					...
					<div class="tab-content mt-2 mb-3" id="pills-without-border-tabContent">
						...
						<div class="tab-pane fade show active" id="pills-one" role="tabpanel" aria-labelledby="pills-one-tab">
							...
							<div class="col-lg-8 ml-auto mr-auto">
								<div class="card">
									<div class="card-body">
                                        <?php $result = $mysqli->query("SELECT * FROM tbl_products ORDER BY id DESC") or die($mysqli->connect_error); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-button-action">
                                                            <!-- Edit Modal -->
                                                            <a href="#" class="btn btn-rounded" data-toggle="modal" data-target="#edit-modal<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" title="Edit Products"><i class="fas fa-edit"></i></a>
                                                            ...
                                                            <!-- Delete Modal  -->
                                                            <a href="#" class="btn btn-rounded" data-toggle="modal" data-target="#delete-modal<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" title="Delete Product"><i class="fas fa-trash-alt text-danger"></i></a>
