                    ...
                    <li class="nav-item active">
                        ...
                        <div class="dropdown-menu animated" aria-labelledby="navbarDropdown">
                            ...
                            <?php if($_SESSION["role"] == "Developer" || $_SESSION["role"] == "Admin"):?>
                                ...
                                <a class="dropdown-item" href="pi/index.php">Prime International</a>
                            ...
                            <div class="dropdown-menu quick-actions quick-actions-info">
                                ...
                                <div class="quick-actions-scroll scrollbar-outer">
                                    <div class="quick-actions-items">
                                        <div class="row m-0">
                                            <?php if($_SESSION["role"] == "Developer" || $_SESSION["role"] == "Admin"):?>
                                            <a class="col-6 col-md-6 p-0" href="manage-users.php">
                                                <div class="quick-actions-item">
                                                    <div class="avatar-item rounded-circle text-danger">
                                                        <i class="fas fa-user-cog"></i>
                                                    </div>
                                                    <span class="text-secondary2">Manage Users</span>
                                                </div>
                                            </a>
                                            <?php else: ?>
                                            <?php endif;?>
                                            ...
                                            <a class="col-6 col-md-6 p-0 mr-auto ml-auto" href="../include/logout.php">
                                                <div class="quick-actions-item">
                                                    <div class="avatar-item rounded-circle text-danger">
